...
namespace SADXModManager.Forms
{
    public partial class ErrorDialog : Form
    {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo("cmd", $"/c start https://github.com/X-Hax/sadx-manager-classic/issues") { CreateNoWindow = true });
            Close();
        }
